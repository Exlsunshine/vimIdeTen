...
let g:tagbar_left = 0                                "在左侧                                              
let g:tagbar_right = 1                                "在右侧                                              
let g:tagbar_width = 40                               "设置宽度                                            
...
function! ReBuildCtags()
    "exec "!find . -name '*.h'"
    exec "!find ~/QQMail/mmux -name '*.h' -o -name '*.c' -o -name '*.cpp' > ~/.vim/src.files && ctags -R --c++-kinds=+px --fields=+iaS --extra=+q -L ~/.vim/src.files  -f ~/.vim/tag/mmux"
...
func SetTitle()
    ...
    if (&filetype == 'sh')
        ...
        call append(line("."), "#########################################################################")
        call append(line(".")+1, "# Author: daviddwguo")
